...
class MainUI extends UIBase {
    ...
    childRender() {
        ...
        return <Grid container spacing={2}>
            <Grid item xs={12}>
                {this.props.selected instanceof Settlement ? <SettlementComponent setSelected={this.props.setSelected} settlement={this.props.selected} game={this.game} stickyHeaderHeight={this.props.stickyHeaderHeight}/> : null}
